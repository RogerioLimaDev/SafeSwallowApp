  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        ...
        <div className="absolute left-4 sm:left-8 right-0 px-4 sm:px-8" style={{ bottom: '2.5rem' }}>
          <img 
        ...
        {/* Botão - lado direito, subido */}
        <div className="flex justify-end pr-2 sm:pr-4" style={{ marginBottom: '1rem' }}>
          <button 
