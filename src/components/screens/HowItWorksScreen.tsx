...
export const HowItWorksScreen: React.FC<HowItWorksScreenProps> = ({ onNext }) => {
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="absolute inset-0 w-full h-full pointer-events-auto bg-transparent flex flex-col items-center justify-between p-6 sm:p-8 pb-10"
    >
      <div className="max-w-xl w-full flex flex-col items-start pt-2">
        ...
        <div className="text-[#482323] text-sm sm:text-base font-gothic-book leading-snug text-left max-w-[95%]">
          <p>
