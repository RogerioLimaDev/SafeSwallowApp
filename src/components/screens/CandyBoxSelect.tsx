...
export const CandyBoxSelect: React.FC<CandyBoxSelectProps> = ({ setPillSize, onNext, unlockedLevels, onSelectLevel }) => {
  ...
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="absolute inset-0 w-full h-full pointer-events-auto bg-transparent flex flex-col items-center justify-between px-4 py-8 pb-[max(2rem,env(safe-area-inset-bottom,2rem))]"
    >
